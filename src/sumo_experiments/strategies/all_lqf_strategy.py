...
from sumo_experiments.agents import LQFAgent


class LQFStrategy(Strategy):
    """
    Implement a longest queue first agent for all intersections of the network.
    """
    ...
    def _generate_agents(self, periods, counted_vehicles, yellow_times):
        ...
        for intersection in self.relations:
            agent = LQFAgent(id_intersection=intersection,
