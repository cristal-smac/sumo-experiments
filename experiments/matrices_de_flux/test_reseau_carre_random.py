...
if __name__ == '__main__':
    ...
    e = Experiment(f'test_reseau_carre_random', network=network.random_square_crossroad_network,
    ...
    e.run(gui=True)
    #e.run_traci(network.feux_a_seuils_communicants_sans_anticipation_reseau_carre, gui=True)
